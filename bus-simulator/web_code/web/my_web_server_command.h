...
/**
This class is being implemented to
represent the Pause button's command.
It takes in only one argument ( a VisualizationSimulator
object), and only has one function ( execute() ).
*/
